      ...
      >
        ...
        <DialogContent>
          <DialogContentText color="#64748B" sx={{ mb: 2 }}>
            {approvalDialog.action === 'approve' 
              ? 'Are you sure you want to approve this team member? They will gain access to the system immediately.'
              : 'Please provide a reason for rejecting this team member. This will be sent to the member via email.'}
          </DialogContentText>
          ...
          {approvalDialog.action === 'reject' && (
            <TextField
              ...
              placeholder="Please explain why this team member is being rejected..."
              multiline
              rows={3}
